...
{
	int sockfd, redo=0;
	char tmp_file[]="/tmp/110009168.XXXXXX";
	char server_vm[MAX_LINE],hostname[PATH_LEN],first_msg[]="time please!";
	...
	strncpy(cliaddr.sun_path, tmp_file, sizeof(cliaddr.sun_path));
	Bind(sockfd, (SA*)&cliaddr, sizeof(cliaddr));
 	
	strncpy(hostname, get_host_name(canon_addr), HOSTNAME_LEN);
